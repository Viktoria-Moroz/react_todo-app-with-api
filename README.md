...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Viktoria-Moroz.github.io/react_todo-app-with-api/) and add it to the PR description.
